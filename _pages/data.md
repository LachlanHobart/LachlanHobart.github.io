...
Each catalogue includes:

- Gaia DR3 astrometry
- Gaia photometry
- Supplementary UKIDSS photometry where available
- Absolute magnitudes
- Stellar masses derived from PARSEC isochrones
- Stellar masses derived from MIST isochrones
- Stellar masses derived from an empirical mass-luminosity relation
...
If these catalogues are used in scientific work, please cite the associated publication:

> Hobart et al. (In preparation).

Please also acknowledge the Gaia mission and any supplementary surveys used in constructing these catalogues.
